...
% \begin{scope}[cm={{1,0.0,0.0,-1,(0,0)}}]
  ...
  \node[color=white,scale=0.8] at (690,15){\insertframenumber/\inserttotalframenumber};
  
  \node at(630,509){\textcolor{white}{\includegraphics[scale=0.15]{./theme/NTU_logo_white}}};
  
  \node at (370,15){$\resizebox{6cm}{!}{\textcolor{white}{Inverse Nonlinear Fourier Transform: Applications in QSP}}$};
